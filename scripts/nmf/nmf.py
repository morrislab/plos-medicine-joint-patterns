...
def get_arguments():
    ...
    parser.add_argument(
        ...
        default=0.,
        metavar='ALPHA',
        help='use %(metavar)s as the regularization constant (default: '
        '%(default)s)')
...
def run_nmf(data, k, init, l1_ratio, alpha):
    """
    ...
    nmf = NMF(n_components=k, init=init, l1_ratio=l1_ratio, alpha=alpha)
...
if __name__ == '__main__':
    ...
    write_output(nmf, basis, scores, args.model_output, args.basis_output,
                 args.score_output)
