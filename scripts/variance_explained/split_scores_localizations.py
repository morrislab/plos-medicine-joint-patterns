...
def main(score_input: str, localization_input: str, output_dir: str):
    ...
    split_scores = {k: scores.loc[v.index] for k, v in split_clusters.items()}
    ...
    for k in split_clusters.keys():
        ...
        split_scores[k].to_csv(str(output_dir / f'{k}.csv'))
